...
- 💾 **OS which I use:** Windows, Linux (have experience with literally all distributions, but mainly prefer to use Arch Linux), FreeBSD, Android, ReactOS, iOS
...
[![](https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif)](https://www.paypal.com/donate/?hosted_button_id=SHZMGX8W8MV6Y)
  ...
  My goal for donations: save enough money from donations and buy a **Lenovo ThinkPad T480** with **Intel Core i7 8 Gen**, **16 GB RAM**, **SSD**, **1920x1080** up to **200$**. Big Thanks for all your donations!
